...
public class CommunicationLineParameters implements LineParameters {
    ...
    static public boolean compare_RS_PARAMETERS(LineParameters curent, LineParameters newvalue) {
        ...
        if (curent instanceof CommunicationLineParameters && newvalue instanceof CommunicationLineParameters) {
            if (((CommunicationLineParameters) newvalue).purge_tx || ((CommunicationLineParameters) newvalue).purge_rx)
                return false;
            ...
            if (LineParameters.getBooleanParameter(newvalue, RS_PURGE_RX) || LineParameters.getBooleanParameter(newvalue, RS_PURGE_TX))
                return false;
    ...
    public Object getLineParameter(String name) {
        ...
        switch (name) {
            case LineParameters.IP_ADDRESS:
                return ipadress;
            case LineParameters.IP_PORT:
                return port;
            case LineParameters.RS_SPEED:
                return baoudrate;
            case LineParameters.RS_PARITY:
                return paritytype;
            case LineParameters.RS_STOBIT:
                return stopbit;
            case LineParameters.RS_DATABIT:
                return databits;
            case LineParameters.SUB_LINE_NUMBER:
                return sublinenum;
            case LineParameters.RS_RTS:
                return rts;
            case LineParameters.RS_DTR:
                return dtr;
            case LineParameters.RS_FLOWCONTROL:
                return flowcontrol;
            case LineParameters.NEED_LINE_CHANGE:
                return needLineChange;
            case LineParameters.RS_PURGE_TX:
                return purge_rx;
            case LineParameters.RS_PURGE_RX:
                return purge_tx;
            case LineParameters.ALWAYS_SET_LINE_PARAM:
                return always_set_line_param;
            case LineParameters.ALWAYS_SET_LINE:

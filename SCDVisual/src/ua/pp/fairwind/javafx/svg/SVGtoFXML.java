package ua.pp.fairwind.javafx.svg;
 ...
 * @author Jasper
 */
public class SVGtoFXML extends Application {

    public static void main(String[] args) { Application.launch(args); }
    
    @Override public void start(final Stage primaryStage) throws Exception {
        primaryStage.setTitle("SVG to FXML Converter");
        BorderPane root = new BorderPane();
        ToolBar toolbar = new ToolBar();
        root.setTop(toolbar);
        Button loadButton = new Button("Convert SVG...");
        ...
        loadButton.setOnAction(event -> {
            ...
            try {
                ...
                Transformer transformer = tFactory.newTransformer(
                        new StreamSource(SVGtoFXML.class.getResourceAsStream("svg2fxml.xsl")));
                ...
                Node content = FXMLLoader.load(outFile.toURI().toURL(), null, new JavaFXBuilderFactory());

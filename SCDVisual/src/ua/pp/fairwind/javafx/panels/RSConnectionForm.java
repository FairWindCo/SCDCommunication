...
public class RSConnectionForm  extends SimpleView {
    ...
    public RSConnectionForm setupDataBit(int index){
        portdataBits.getSelectionModel().clearAndSelect(index);return this;
    }

    public RSConnectionForm setupStopBit(int index){
        portstopBits.getSelectionModel().clearAndSelect(index);return this;
    }

    public RSConnectionForm setupParity(int index){
        portparity.getSelectionModel().clearAndSelect(index);return this;
    }

    public RSConnectionForm setupPortIndex(int index){
        ports.getSelectionModel().clearAndSelect(index);return this;
    }

...
public class PropertyConfigDialog {
    ...
    private PropertyConfigDialog() {
        checkBox=new CheckBox(I18N_FX.getLocalizedString("CONFIG_PROPERTY_ENABLE_IMMEDIATELY_WRITE"));
        ...
        table=new TableView<>();
        TableColumn<PropertyTimer, String> col1= new TableColumn<>(I18N_FX.getLocalizedString("CONFIG_PROPERTY_AVIABLE_TIMERS"));
        ...
        ButtonCell col2=new ButtonCell(I18N_FX.getLocalizedString("CONFIG_PROPERTY_REMOVE_TIMER"));
        TableColumn<PropertyTimer,String> col_action = new TableColumn<>("Action");
        col_action.setCellValueFactory((p)->new SimpleStringProperty(I18N_FX.getLocalizedString("CONFIG_PROPERTY_REMOVE_TIMER")));


        col_action.setCellFactory(p ->new ButtonCell(I18N_FX.getLocalizedString("CONFIG_PROPERTY_REMOVE_TIMER")));


        table.getColumns().add(col1);
        table.getColumns().add(col_action);
        add=new Button(I18N_FX.getLocalizedString("CONFIG_PROPERTY_ADD_TIMER"));
    ...
    private void setupProprty(AbstractProperty property){
        ...
        dialog.setHeaderText(I18N_FX.getLocalizedString("CONFIG_PROPERTY:")+property.getName()+" "+property.getDescription());

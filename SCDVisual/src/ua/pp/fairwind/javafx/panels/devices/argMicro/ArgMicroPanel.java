...
public class ArgMicroPanel extends HBox {
    ...
    private void intiDeviceControlPane(){
        ...
        Platform.runLater(() -> {
            ...
            rowIndex = setFloatChanelControl(grid, device.getRate(), I18N.getLocalizedString("RATE"), rowIndex++, 0);
            rowIndex = setShortChanelControl(grid, device.getNumberMeasurementm(), I18N.getLocalizedString("NUMBER_MEASUREMENT"), rowIndex++, 0);

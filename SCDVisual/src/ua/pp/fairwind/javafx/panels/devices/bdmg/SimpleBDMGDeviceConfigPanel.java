 ...
 */
public class SimpleBDMGDeviceConfigPanel extends HBox {
    ...
    public SimpleBDMGDeviceConfigPanel(BDMG04 device) {
        super();
        this.device = device;
    ...
    public SimpleBDMGDeviceConfigPanel(BDMG04 device, LineInterface line, List<LineInterface> lines) {
        super();
        this.device = device;
        selectedLine = device.getPrimaryLine();
        this.lines = lines;
    ...
    public SimpleBDMGDeviceConfigPanel(BDMG04 device, LineInterface line, List<LineInterface> lines, LineChange listener) {
        super();
        this.device = device;
        selectedLine = device.getPrimaryLine();
        this.lines = lines;
    ...
    public SimpleBDMGDeviceConfigPanel(BDMG04 device, LineInterface line) {
        super();
        this.device = device;
        selectedLine = device.getPrimaryLine();
        lines = null;
    ...
    private void initControl() {
        ...
        grid.add(VisualControls.createBDMGProtoclSelect(device.getBdmg04Protocol()), 2, rowindex++);

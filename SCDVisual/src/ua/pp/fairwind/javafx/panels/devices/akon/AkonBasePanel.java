...
public class AkonBasePanel extends HBox {
    ...
    public static ComboBox<Byte> createParitySelect(SoftByteProperty addressProperty){
        ...
        box.setConverter(new StringConverter<Byte>() {
            ...
            public String toString(Byte value) {
                switch (value){
                    case 0x0:return"ptNone";
                    case 0x1:return"ptOdd";
                    case 0x2:return"ptEven";
                    case 0x3:return"ptMark";
                    case 0x4:return"ptSpace";
                    default:return "ptNone";
                }
            }
            ...
            public Byte fromString(String value) {
                switch (value){
                    case "ptNone":return 0x0;
                    case "ptOdd":return 0x1;
                    case "ptEven":return 0x2;
                    case "ptMark":return 0x3;
                    case "ptSpace":return 0x4;
                    default:return 0x0;
                }
            }
        });

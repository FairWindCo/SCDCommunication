...
public class FavoritTestPanel extends HBox {
    ...
    private void initControl() {
        ...
        grid.add(new Label(I18N_FX.getLocalizedString("DO1")), 10, rowindex++);

        grid.add(new Label(I18N_FX.getLocalizedString("DI2")), 0, rowindex);
        ...
        grid.add(new Label(I18N_FX.getLocalizedString("DO2")), 10, rowindex++);

        grid.add(new Label(I18N_FX.getLocalizedString("DI3")), 0, rowindex);
        ...
        grid.add(new Label(I18N_FX.getLocalizedString("DO3")), 10, rowindex++);

        grid.add(new Label(I18N_FX.getLocalizedString("DI4")), 0, rowindex);
        ...
        grid.add(new Label(I18N_FX.getLocalizedString("DO4")), 10, rowindex++);

        grid.add(new Label(I18N_FX.getLocalizedString("DI5")), 0, rowindex);
        ...
        grid.add(new Label(I18N_FX.getLocalizedString("DO5")), 10, rowindex++);

        grid.add(new Label(I18N_FX.getLocalizedString("DI6")), 0, rowindex);
        ...
        grid.add(new Label(I18N_FX.getLocalizedString("AO1")), 10, rowindex++);


        grid.add(new Label(I18N_FX.getLocalizedString("AI2")), 0, rowindex);
        ...
        grid.add(new Label(I18N_FX.getLocalizedString("AO2")), 10, rowindex++);

        grid.add(new Label(I18N_FX.getLocalizedString("AI3")), 0, rowindex);
        ...
        grid.add(new Label(I18N_FX.getLocalizedString("AO3")), 10, rowindex++);

        grid.add(new Label(I18N_FX.getLocalizedString("AI4")), 0, rowindex);
        ...
        grid.add(new Label(I18N_FX.getLocalizedString("DEVICE SPEED")), 6, rowindex);

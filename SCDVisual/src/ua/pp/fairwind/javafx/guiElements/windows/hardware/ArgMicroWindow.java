...
public class ArgMicroWindow extends SimpleHardWareViewMenu {
    ...
    public ArgMicroWindow(String menuItem, SCADASystem centralsystem, String deviceName, String deviceNameDecription) {
        super(menuItem, centralsystem, AutoCreateDeviceFunction.ARG_MICRO, deviceName, deviceNameDecription);
    }

    public ArgMicroWindow(String menuItem, SCADASystem centralsystem) {
        super(menuItem, centralsystem, AutoCreateDeviceFunction.ARG_MICRO, menuItem, null);
    }

    @Override
    protected Node createView() {
        ArgMicroDevice device=(ArgMicroDevice)centralsystem.createDevice(deviceType, deviceName, deviceNameDecription);

package ua.pp.fairwind.javafx.guiElements.LogarithmicAxis;
...
import ua.pp.fairwind.javafx.guiElements.LogarithmicAxis.IllegalLogarithmicRangeException;
...
public class LogarithmicAxis extends ValueAxis<Number> {
	...
	protected List<Number> calculateTickValues(double length, Object range) {
		...
		if (range != null) {
			...
			double logLowerBound1 = Math.log10(lowerBound.doubleValue());
			double logUpperBound1 = Math.log10(upperBound.doubleValue());
			this.logLowerBound.setValue(logLowerBound1);
			this.logUpperBound.setValue(logUpperBound1);
	
			for (double i = 0; i <= logUpperBound1; i += 1) {
